                ...
                <div class="card-body">
                    ...
                    <form method="post" action="/ujian/update/{{ $ujian->id }}">
                        ...
                        <div class="form-group">
                            <label>Nama</label>
                            <input type="text" name="nama_mk" class="form-control" placeholder="Nama Mahasiswa .." value=" {{ $ujian->nama_mk }}">
                        ...
                        <div class="form-group">
                            <label>Dosen</label>
                            <input name="dosen" class="form-control" placeholder="Dosen .." value=" {{ $ujian->dosen }}">
                        ...
                        <div class="form-group">
                            ...
                            <input name="jumlah_soal" class="form-control" placeholder="Jumlah Soal .." value=" {{ $ujian->jumlah_soal }}">
